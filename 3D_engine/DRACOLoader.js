...
THREE.DRACOLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
	...
	_initDecoder: function () {
		...
		if ( useJS ) {
			...
			librariesPending.push( this._loadLibrary( 'libs/draco_decoder.js', 'text' ) );

		} else {

			librariesPending.push( this._loadLibrary( 'libs/draco_wasm_wrapper.js', 'text' ) );
			librariesPending.push( this._loadLibrary( 'libs/draco_decoder.wasm', 'arraybuffer' ) );
